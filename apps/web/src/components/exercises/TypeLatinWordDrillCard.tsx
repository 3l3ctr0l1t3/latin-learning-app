      ...
      <Box sx={{ 
        ...
        <Box sx={{ flex: 1 }}>
          ...
          >
            ...
            <ToggleButton
                value="common"
                data-testid="button-gender-common"
                sx={{
                  color: hasAnswered && selectedGender === 'common'
                      ? (currentWord.gender === 'common' ? 'success.main' : 'error.main')
                      : undefined
                }}
            >
              Común
          ...
          {hasAnswered && selectedGender !== currentWord.gender && (
            <Typography variant="caption" color="error" sx={{ mt: 0.5, display: 'block' }}>
              Correcto: {currentWord.gender === 'masculine' ? 'Masculino' : 
                        currentWord.gender === 'feminine' ? 'Femenino' : currentWord.gender === 'neuter' ? 'Neutro': 'Común'}
            </Typography>
          )}
        </Box>
