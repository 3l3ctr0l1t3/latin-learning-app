...
import { RADIUS } from '../../features/study-session/constants/spacing';
        ...
        {questionType === 'spanishToLatin' ? (
          ...
          >
            ...
            <Box sx={{ 
              ...
              />
              <Chip 
                label={currentWord.gender === 'masculine' ? 'Masculino' : currentWord.gender === 'feminine' ? 'Femenino' :currentWord.gender === 'neuter' ? 'Neutro': 'Común'}
                size="small"
                sx={{ 
